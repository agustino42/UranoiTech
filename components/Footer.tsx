      ...
      <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <a href="#" className=" hover:underline">Sobre UranoItech</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Grupo de Trabajo</a>
                </li>
                <li className="mb-4">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Contacto (Telegram)</a>
                </li>
            </ul>
        </div>
        <div>
